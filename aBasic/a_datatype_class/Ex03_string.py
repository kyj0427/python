...
""" [ 연습-1 ]
    ...
    '12시 5분' 출력
"""
s='2020-02-22 : 12:05:12'
print([s[:10]])
print(s[:4] + '년' + s[5:7] + '월' + s[8:10]+'일')
print(s[12:-3])
print(s[13:15]+'시' + s[-5:-3] + '분')
...
""" [ 출력결과 ]
    ...
    5) '도'라는 단어의 갯수 구하기
"""
print(msg.index('행복')) # s.index는 찾으려는(문자열) 있어야지만 사용가능
print(msg.find('가자'))
print(msg.rfind('행복'))
print(len(msg))
print(msg.count('도'))
